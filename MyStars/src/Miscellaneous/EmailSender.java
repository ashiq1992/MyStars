...
public class EmailSender {
	...
	private static String USER_NAME = "starsplannerntu";  // GMail user name (just the part before "@gmail.com")
    private static String PASSWORD = "javaproject"; // GMail password
